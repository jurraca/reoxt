defmodule ReoxtWeb.GraphLive do
  ...
  def render(assigns) do
    ...
    <div class="container mx-auto px-4 py-6">
      ...
      <!-- Error Display -->
      <%= if @error do %>
        <div class="rounded-lg p-4 mb-6 border" style="background: linear-gradient(145deg, #1a0a0a, #2a1a1a); border-color: #ff4444; box-shadow: 0 0 20px rgba(255, 68, 68, 0.3);">
          <div class="flex">
            <div class="flex-shrink-0">
              <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20" style="color: #ff4444; filter: drop-shadow(0 0 4px #ff4444);">
                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd" />
              </svg>
            </div>
            <div class="ml-3">
              <h3 class="text-sm font-semibold mb-2" style="color: #ff4444; text-shadow: 0 0 8px #ff4444;">Transaction Error</h3>
              <div class="text-sm text-gray-300" style="text-shadow: 0 0 4px rgba(255, 255, 255, 0.1);">
                <%= @error %>
              </div>
            </div>
          </div>
