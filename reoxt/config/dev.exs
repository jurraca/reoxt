...
config :reoxt, Reoxt.Repo,
  database: Path.expand("../reoxt_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :reoxt, ReoxtWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "doiJVs0ogc183fbSwBGhQHEbz6wLMJPxt02N/ZLR6dlx3Jc0TtG5yP8SKNPy4AU0",
  watchers: [
...
config :reoxt, ReoxtWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/reoxt_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]
